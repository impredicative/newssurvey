...
_HEXT = hext.Rule("""
    ...
    """)
MAX_PAGE_NUM = 40  # Observed empirically. Ex: https://phys.org/search/page41.html?search=world&s=0
...
def _get_search_response(query: str, *, sort_by: str = "relevancy", headlines: bool = False, page_num: int = 1) -> requests.Response:
    """Return a response from the Phys website for a given query, sorting preference, and page number.
    ...
    """
    url = f"https://phys.org/search/page{page_num}.html"
