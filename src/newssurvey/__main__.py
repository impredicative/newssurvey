...
@click.option("--output-path", "-o", required=True, type=Path, help="Output text file path with extension txt. The response is written to this file except if there is an error.")
