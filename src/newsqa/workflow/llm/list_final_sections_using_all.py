...
def _list_final_sections(user_query: str, source_module: ModuleType, draft_sections: list[str], *, max_sections: int, max_attempts: int = 3) -> list[str]:
    ...
    prompt_data["task"] = PROMPTS["4. list_final_sections_using_all-initial"].format(**prompt_data, draft_sections=numbered_draft_sections_str, max_sections=max_sections)
